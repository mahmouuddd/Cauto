...
When(`I fill the form with valid data`, () => {
    ...
    cy.get(ajoutColisElem.villeDepart).type('Manouba')
    cy.get(ajoutColisElem.bizerte).click()
    cy.get(ajoutColisElem.villeArrivee).type('Bizerte')
    cy.get(ajoutColisElem.mahdia).click()
    cy.get(ajoutColisElem.dateDepart).click()
    cy.get(ajoutColisElem.dateDepart).type('2025-01-28')
    cy.get(ajoutColisElem.dateArrivee).type('2025-01-31')
